...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Nilufar Shaikh",
    title:
      "Full Stack Software Engineer | React JS, Node JS, PHP, Python, MySQL, MongoDB | 6+ Years in the IT Industry",
  ...
  },
  {
    ...
    name: "Samreen Aziz",
    title:
      "Software Engineering | Natural Resources, Healthcare, Banking, Education | ex-IBM",
  ...
  },
  {
    ...
    name: "Farheen Syed",
    title:
      "Full Stack Software Engineer | React JS, Node JS, PHP, Python, MySQL, MongoDB | Health Technology Coder | Lifelong Learner",
